...
enum IoTSensorType { vehicleCounter, speedSensor, pollutionSensor, accidentDetector, signalTimer }
enum AIAlertType { accident, stalledVehicle, heavyCongestion, sensorFailure, unusualPattern }
