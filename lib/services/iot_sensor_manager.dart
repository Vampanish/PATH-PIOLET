...
class IoTSensorManager {
  ...
  IoTSensor? getSensor(String id) => _sensors[id];
...
class SensorNetworkStatistics {
  ...
  double get healthPercentage => (healthySensors / totalSensors) * 100;
  double get activePercentage => (activeSensors / totalSensors) * 100;
}
